...
class Product
{
    ...
    /** @var \Src\Products\Domain\Data\Store[] array */
    public array $stores = [];
    ...
    /**
     * @param \Src\Products\Domain\Data\Compositions\Composition[]|null $compositionProducts
     */
    ...
    /**
     * @return \Src\Products\Domain\Data\Store[]
     */
